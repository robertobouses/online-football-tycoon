...
(gen_random_uuid(), (SELECT id FROM oft.team WHERE name = 'Unión Deportiva Río Claro'), 'Erik', 'Larsen', 'DNK', 'defender', 30, 3500000, 94000, 74, 76, 73, 0, false, 82, 84, 87),
...
(gen_random_uuid(), (SELECT id FROM oft.team WHERE name = 'Unión Deportiva Río Claro'), 'Nicolás', 'Gómez', 'URY', 'midfielder', 28, 3300000, 90000, 72, 74, 71, 0, false, 80, 82, 85),
...
(gen_random_uuid(), (SELECT id FROM oft.team WHERE name = 'Unión Deportiva Río Claro'), 'James', 'Wilson', 'GBR', 'forward', 29, 3400000, 92000, 73, 75, 72, 0, false, 81, 83, 86),
